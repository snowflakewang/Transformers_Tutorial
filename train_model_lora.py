...
if __name__ == '__main__':
    ...
    parser.add_argument('--lora_dropout', type=float, default=0.1, help='LoRA dropout ratio')
    ...
    lora_configs = peft.LoraConfig(r=options.lora_rank,
        lora_alpha=options.lora_alpha,
        target_modules=['query', 'value'],
        lora_dropout=options.lora_dropout,
        bias="none",
        task_type=peft.TaskType.SEQ_CLS) 
    model = peft.get_peft_model(model=model, peft_config=lora_configs)
